...
public class EstateSurroundingFragment extends BaseFragment {

    @BindView(R.id.id_stickynavlayout_innerscrollview)
    ScrollView lvInfo;

    public static EstateSurroundingFragment newInstance() {
        EstateSurroundingFragment fragment = new EstateSurroundingFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_estate_surrounding, container, false);
